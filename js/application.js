	...
	window.pages = ['portada', 'contraportadilla', 'portadilla', 'creditos', 'cara', 'antecara', 'pagina1', 'pagina2', 'pagina3', 'pagina4', 'pagina5', 'pagina6', 'pagina7', 'pagina8', 'pagina9', 'pagina10', 'pagina11', 'pagina12', 'pagina13', 'pagina14', 'pagina15', 'pagina16', 'pagina17', 'pagina18', 'tapa', 'agradecimientos', 'anuncio', 'contraportada'];
	...
	$(document).ready(function() {
		...
		$('#magazine').turn({page: checkHash(), gradients: !$.isTouch, acceleration: false, elevation: 50});
